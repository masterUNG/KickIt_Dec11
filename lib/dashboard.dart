...
class _FourTabState extends State<FourTab> {
  ...
  Widget build(BuildContext context) {
    var data = [
      ClickPerMonth('Match', 80, Colors.purple),
      ClickPerMonth('Goal', 42, Colors.blue),
      ClickPerMonth('Assist', 54, Colors.green),
      ClickPerMonth('Clean', 0, Colors.white),
      ClickPerMonth('Yellow', 6, Colors.yellow),
      ClickPerMonth('Red', 5, Colors.red),
    ];
